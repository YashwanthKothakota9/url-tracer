...
/* harmony import */ var webext_bridge_background__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! webext-bridge/background */ "./node_modules/webext-bridge/dist/background.js");
...
(0,webext_bridge_background__WEBPACK_IMPORTED_MODULE_0__.onMessage)('RETURN_STATS', announceAction);
function announceAction(_x) {
  return _announceAction.apply(this, arguments);
}
function _announceAction() {
  _announceAction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var data, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return browser.storage.local.get(['urlVisitTimes']);
        case 5:
          response = _context.sent;
          console.log('From BAckground:', response);
          return _context.abrupt("return", {
            message: response.urlVisitTimes
          });
        case 8:
        case "end":
...
function updateTimeOnTab(tabId) {
  ...
  if (activeTabId !== null) {
    ...
    browser.tabs.get(activeTabId).then(function (tab) {
      if (!tab.url || tab.url.startsWith('chrome://newtab') || tab.url.startsWith('about:newtab') || tab.url.startsWith('chrome://extensions') || tab.url.startsWith('chrome://')) {
      ...
      var domainName = extractDomain(tab.url);
      var faviconUrl = tab.favIconUrl || '';
      // Fetch the current data, update it, and store it again
      browser.storage.local.get(['urlVisitTimes']).then(function (result) {
        var currentData = result.urlVisitTimes || {};
        console.log('CurrentData Get:', currentData);

        // Update the time for the current URL
        var domainData = currentData[domainName] || {
          timeSpent: 0,
          favicon: faviconUrl
        };
        ...
        browser.storage.local.set({
          urlVisitTimes: currentData
        }).then(function () {
          console.log('Updated data for', domainName, currentData[domainName]);
          console.log('currentData:', currentData);
          (0,webext_bridge_background__WEBPACK_IMPORTED_MODULE_0__.sendMessage)('statsUpdated', {
            updated: true
          }, 'popup');
        });
      });
...
browser.webNavigation.onHistoryStateUpdated.addListener(function (details) {
  ...
  if (details.frameId === 0) {
    ...
    browser.tabs.get(details.tabId).then(function (tab) {
      ...
      return console.error('Error fetching tab:', error);
    });
  }
}, {
  url: [{
...
/***/ "./src/popup/resources/css/styles.css":
/*!********************************************!*\
  !*** ./src/popup/resources/css/styles.css ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-G7AOUSAZ.js */ "./node_modules/webext-bridge/dist/chunk-G7AOUSAZ.js");
/* harmony import */ var _chunk_QIZ4XBKF_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-QIZ4XBKF.js */ "./node_modules/webext-bridge/dist/chunk-QIZ4XBKF.js");
/* harmony import */ var _chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-REMFLVJH.js */ "./node_modules/webext-bridge/dist/chunk-REMFLVJH.js");
/* harmony import */ var webextension_polyfill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! webextension-polyfill */ "./node_modules/webext-bridge/node_modules/webextension-polyfill/dist/browser-polyfill.js");
...
var pendingResponses = (0,_chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.createDeliveryLogger)();
  ...
  withFingerprint: (fingerprint) => {
    ...
    const notifications = {
      aboutIncomingMessage: (message) => {
        ...
        _chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.PortMessage.toExtensionContext(recipient.port, {
          status: "incoming",
          message
        });
      ...
      aboutSuccessfulDelivery: (receipt) => {
        ...
        _chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.PortMessage.toExtensionContext(sender.port, {
          status: "delivered",
          receipt
        });
        return nextChain(notifications);
      ...
      whenDeliverableTo: (targetEndpoint) => {
        const notifyDeliverability = () => {
          ...
          if ((origin == null ? void 0 : origin.fingerprint) === fingerprint && connMap.has(targetEndpoint)) {
            _chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.PortMessage.toExtensionContext(origin.port, {
              status: "deliverable",
      ...
      aboutSessionEnded: (endedSessionFingerprint) => {
        ...
        if ((conn == null ? void 0 : conn.fingerprint) === fingerprint) {
          _chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.PortMessage.toExtensionContext(conn.port, {
            status: "terminated",
...
var sessFingerprint = (0,_chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.createFingerprint)();
var endpointRuntime = (0,_chunk_QIZ4XBKF_js__WEBPACK_IMPORTED_MODULE_1__.createEndpointRuntime)("background", (message) => {
  var _a;
  ...
  const resolvedSender = (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.formatEndpoint)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.__spreadValues)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.__spreadValues)({}, message.origin), message.origin.context === "window" && { context: "content-script" }));
  const resolvedDestination = (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.formatEndpoint)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.__spreadProps)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.__spreadValues)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.__spreadValues)({}, message.destination), message.destination.context === "window" && {
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_3__.runtime.onConnect.addListener((incomingPort) => {
  var _a;
  const connArgs = (0,_chunk_G7AOUSAZ_js__WEBPACK_IMPORTED_MODULE_0__.decodeConnectionArgs)(incomingPort.name);
  if (!connArgs)
    return;
  connArgs.endpointName || (connArgs.endpointName = (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.formatEndpoint)({
    context: "content-script",
    tabId: incomingPort.sender.tab.id,
    frameId: incomingPort.sender.frameId
  }));
  const { tabId: linkedTabId, frameId: linkedFrameId } = (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_2__.parseEndpoint)(connArgs.endpointName);
...
var { openStream, onOpenStreamChannel } = (0,_chunk_QIZ4XBKF_js__WEBPACK_IMPORTED_MODULE_1__.createStreamWirings)(endpointRuntime);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PortMessage: () => (/* binding */ PortMessage),
/* harmony export */   createDeliveryLogger: () => (/* binding */ createDeliveryLogger),
/* harmony export */   createFingerprint: () => (/* binding */ createFingerprint),
/* harmony export */   decodeConnectionArgs: () => (/* binding */ decodeConnectionArgs),
/* harmony export */   encodeConnectionArgs: () => (/* binding */ encodeConnectionArgs)
/* harmony export */ });
/* harmony import */ var tiny_uid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tiny-uid */ "./node_modules/tiny-uid/index.js");
// src/internal/endpoint-fingerprint.ts

var createFingerprint = () => `uid::${tiny_uid__WEBPACK_IMPORTED_MODULE_0__(7)}`;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createEndpointRuntime: () => (/* binding */ createEndpointRuntime),
/* harmony export */   createStreamWirings: () => (/* binding */ createStreamWirings)
/* harmony export */ });
/* harmony import */ var _chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-REMFLVJH.js */ "./node_modules/webext-bridge/dist/chunk-REMFLVJH.js");
/* harmony import */ var tiny_uid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tiny-uid */ "./node_modules/tiny-uid/index.js");
...
var createEndpointRuntime = (thisContext, routeMessage, localMessage) => {
  const runtimeId = tiny_uid__WEBPACK_IMPORTED_MODULE_1__();
    ...
    if (message.destination.context === thisContext && !message.destination.frameId && !message.destination.tabId) {
      ...
      const handleNewMessage = async () => {
        ...
        try {
          ...
          if (err)
            message.err = (0,serialize_error__WEBPACK_IMPORTED_MODULE_2__.serializeError)(err);
          handleMessage((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__.__spreadProps)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__.__spreadValues)({}, message), {
            messageType: "reply",
            data: reply,
  ...
  return {
    ...
    sendMessage: (messageID, data, destination = "background") => {
      const endpoint = typeof destination === "string" ? (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__.parseEndpoint)(destination) : destination;
      ...
      return new Promise((resolve, reject) => {
        const payload = {
          ...
          messageType: "message",
          transactionId: tiny_uid__WEBPACK_IMPORTED_MODULE_1__(),
          origin: { context: thisContext, tabId: null },
          hops: [],
          timestamp: Date.now()
        };
...
var createStreamWirings = (endpointRuntime) => {
  ...
  const streamyEmitter = (0,nanoevents__WEBPACK_IMPORTED_MODULE_3__.createNanoEvents)();
    ...
    return new Promise((resolve) => {
      ...
      const readyup = () => {
        ...
        if (typeof callback === "function") {
          callback(new Stream(endpointRuntime, (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__.__spreadProps)((0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__.__spreadValues)({}, data), { endpoint: sender })));
          if (watching)
            off();
          resolve(true);
        } else if (!watching) {
  ...
  async function openStream(channel, destination) {
    ...
    const endpoint = typeof destination === "string" ? (0,_chunk_REMFLVJH_js__WEBPACK_IMPORTED_MODULE_0__.parseEndpoint)(destination) : destination;
    const streamInfo = { streamId: tiny_uid__WEBPACK_IMPORTED_MODULE_1__(), channel, endpoint };
...
/* harmony export */   formatEndpoint: () => (/* binding */ formatEndpoint),
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkurl_tracer"] = self["webpackChunkurl_tracer"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["build/popup/css/styles"], () => (__webpack_require__("./src/background.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["build/popup/css/styles"], () => (__webpack_require__("./src/popup/resources/css/styles.css")))
